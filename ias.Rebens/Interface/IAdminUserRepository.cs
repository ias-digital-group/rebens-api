...
namespace ias.Rebens
{
    ...
    {
        ResultPage<AdminUser> ListPage(int page, int pageItems, out string error);

        ResultPage<AdminUser> SearchPage(string word, int page, int pageItems, out string error);
