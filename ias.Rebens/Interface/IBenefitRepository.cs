...
namespace ias.Rebens
{
    public interface IBenefitRepository
    {
        ...
        ResultPage<Benefit> ListPage(int page, int pageItems, string word, string sort, out string error, int? idOperation = null);
        ...
        ResultPage<Benefit> ListByOperation(int idOperation, int? idCategory, string benefitTypes, decimal? latitude, decimal? longitude, int page, int pageItems, string word, string sort, out string error);
