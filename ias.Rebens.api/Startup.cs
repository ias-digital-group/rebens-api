    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseMvc(routes =>
            {
                ...
                routes.MapRoute("GetOrderPdf", "Voucher/GetOrderPdf/{code}", defaults: new { controller = "Voucher", action = "GetOrderPdf" });
                routes.MapRoute("GetOrderPdf", "Voucher/GetOrderItemPdf/{code}/{tkt}", defaults: new { controller = "Voucher", action = "GetOrderItemPdf" });
